...
export const techStack = [
  ...
  'Tailwind CSS', 'Python', 'PostgreSQL', 'Docker',
...
export const experiences = [
  {
    ...
    org: 'BEM Fakultas Teknik',
    period: '2024 — Sekarang',
    type: 'Organisasi',
    description: 'Memimpin divisi teknologi, mengembangkan platform digital BEM, dan mengelola tim 12 orang.',
    color: '#4F8EF7',
  },
  {
    id: 2,
    ...
    period: '2023 — 2024',
    type: 'Komunitas',
    description: 'Mengorganisir workshop bulanan, mentoring anggota baru, dan memimpin 3 project open-source.',
    color: '#7C5CF6',
  },
  {
    id: 3,
    role: 'Frontend Developer Intern',
    org: 'Startup Fintech Jakarta',
    period: 'Jun — Agt 2024',
    type: 'Magang',
    description: 'Membangun dashboard analytics dan mengoptimalkan performa aplikasi React (LCP dari 4.2s ke 1.1s).',
    color: '#38bdf8',
  },
  {
    id: 4,
    role: 'Juara 2 — Hackathon Nasional',
    org: 'HackFest Indonesia',
    period: 'September 2024',
    type: 'Prestasi',
    description: 'Tim 4 orang membangun solusi agritech berbasis computer vision dalam 48 jam.',
    color: '#fbbf24',
  },
  {
    id: 5,
